...
exports.addProduct = catchAsync(async(req, res, next) => {
    ...
    let { pTitle, pCategory, pPrice, pImagePath, pDescription, pOnSale, pOldPrice, pStock } = req.body;
...
exports.showProducts = catchAsync(async(req, res, next) => {
    ...
    const products = await Product.find(req.body).sort([
        ['pTitle', 1]
    ]);
    if (!products) {
        return (new AppError('can not get the products ', 500))
...
exports.showMoreCategories = catchAsync(async(req, res, next) => {
